...
\begin{tikzpicture} [node distance=1cm]
  \node (why1) [
  label={[font=\huge, green, anchor=west, inner sep=.1pt, label distance=1cm, xshift=-2.5cm]west:$How$},
  label={[font=\huge, anchor=east, green, label distance=1.8cm, xshift=-5cm, inner sep=2.5pt]east:$about$},
